  ...
  return (
    <section className="py-10 bg-white sm:py-16 lg:py-24">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <h2 className="text-4xl font-bold text-black sm:text-6xl lg:text-5xl text-center">
          Our {' '}
          <div className="relative inline-flex">
            <span className="absolute inset-x-0 bottom-0 border-b-[20px] border-[#4ADE80]"></span>
            <span className="relative text-4xl font-bold text-black sm:text-6xl lg:text-5xl">
               Service
            </span>
          </div>
        </h2>
        <div className="grid grid-cols-1 gap-12 text-center sm:grid-cols-2 md:grid-cols-3 lg:gap-y-16 mt-20">
          <div>
